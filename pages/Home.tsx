...
const ParallaxImage: React.FC<{ src: string; alt: string }> = ({ src, alt }) => {
  ...
  const handleImageError = () => {
    setImgSrc(
      'data:image/svg+xml;charset=UTF-8,%3Csvg%20width%3D%22800%22%20height%3D%22500%22%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%3E%3Crect%20fill%3D%22%23333333%22%20width%3D%22800%22%20height%3D%22500%22/%3E%3Ctext%20x%3D%22400%22%20y%3D%22260%22%20font-size%3D%2230%22%20fill%3D%22%23cccccc%22%20text-anchor%3D%22middle%22%3EImage%20Unavailable%3C/text%3E%3C/svg%3E'
    );
  };
